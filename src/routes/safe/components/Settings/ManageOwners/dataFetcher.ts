...
import { AddressBookState, AddressBookEntry } from 'src/logic/addressBook/model/addressBook'
...
export const getOwnerData = (owners: AddressBookState): Omit<AddressBookEntry, 'chainId'>[] => {
